...
- `NEXT_PUBLIC_ALERT_FLOOD_THRESHOLD` (0 to 1, default 0.7)
- `NEXT_PUBLIC_ALERT_HEAT_THRESHOLD` (0 to 1, default 0.7)
- `NEXT_PUBLIC_ALERT_AIR_THRESHOLD` (0 to 1, default 0.7)
